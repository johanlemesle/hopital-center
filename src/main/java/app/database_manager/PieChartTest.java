...
public class PieChartTest extends ApplicationFrame {
   ...
   public void tst(Hopital hopital) {
      ...
      Docteur bibiche = new Docteur("Bibiche", "Ichli", "0165345321",
            new Adresse("9", "rue", "du Dassault Dassault", "78140", "Vélizy Villacoublay"), Specialite.generaliste);
      ...
      Infirmier marec = new Infirmier("Marec", "Affeli", "0670223410",
            new Adresse("12", "avenue", "Lazare Carnot", "78220", "Viroflay"), asile, Rotation.Jour, 1540.4, null);

      Infirmier jamel = new Infirmier("Debbouze", "Jamel", "0654237612",
            new Adresse("11", "avenue", "Lazare ", "78220", "Luciole"), asile, Rotation.Jour, 1520.09, null);
      Infirmier ramzi = new Infirmier("Kika", "Ramzi", "0654237612",
            new Adresse("11", "avenue", "Lazare ", "78220", "Luciole"), radiologie, Rotation.Jour, 1520.1, null);

      Infirmier diane = new Infirmier("Vilandrau", "Diane", "0654237612",
            new Adresse("11", "avenue", "Bleuet ", "78220", "Luciole"), pediatrie, Rotation.Jour, 1520.4, null);
      ...
      ArrayList<Pair<String, Object>> resultat = Utils.get(
            "malades{*}&services{*}&docteurs{*}&infirmiers{*}&hospitalisations{*}&chambres{*}&employes{*}", hopital);
      ...
      PieChartTest chart1 = new PieChartTest("JABARI LEMESLE LAHDIRI", dataset, "Nb hospitalisations par service");
