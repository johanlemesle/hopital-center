...
public class App {
        ...
        public static void main(String[] args) 
        {
                ...
                Patient john = new Patient("Dark", "John", "0353426153",
                                new Adresse("26", "quai", "de grounelle", "75003", "Paris sur Orge"));

                Patient hermione = new Patient("Granger", "Hermione", "0023212322",
                ...
                //On ne peut pas faire deux hospitalisation différente sur un même patient car 
                // même clé
                ...
                Hospitalisation dechirure = new Hospitalisation(hermione, urgence, room205, 1);
                ...
                hopital.insert("patient", john);
                hopital.insert("patient", hermione);
